...
from models.shattetnion.ShDecoderSidechain import SHSidechainDecoder,DynamicKSidechainDecoder,SHTypeHybridHead,assemble_atom14_with_CA,assemble_atom14
...
class FlowModel_sh(nn.Module):

    def __init__(self, model_conf):
        super(FlowModel_sh, self).__init__()
