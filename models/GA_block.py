...
from models.geom_attention import (
    GeometricReasoningOriginalImpl,
)

from openfold.utils.rigid_utils import Rigid as Affine3D
...
class UnifiedTransformerBlock(nn.Module):
    ...
    def __init__(
        self,
        d_model: int,
        use_geom_attn: bool = True,
        use_plain_attn: bool = False,
    ...
    def forward(
        ...
        if self.use_geom_attn:
            r2 = self.geom_attn(x, frames, frames_mask.bool(), sequence_id, chain_id)
