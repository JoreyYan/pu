...
def prot_to_torsion_angles(aatype, atom37, atom37_mask):
    ...
    # 方式1：分步调用
    transform_func = data_transforms.atom37_to_torsion_angles(prefix="")
    torsion_angles_feats = transform_func(prot_feats)

    torsion_alt_angles = torsion_angles_feats['alt_torsion_angles_sin_cos']
    torsion_angles = torsion_angles_feats["torsion_angles_sin_cos"]
    torsion_mask = torsion_angles_feats["torsion_angles_mask"]
    return torsion_angles, torsion_alt_angles,torsion_mask
